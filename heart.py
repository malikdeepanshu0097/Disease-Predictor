...
def takeInput():
    ...
    if final_Result[0] == 1:
        ...
        label3 = tkinter.Label(substituteWindow, text = "Heart & Vascular Clinic", font=('Times', -15))
        label3.grid(row=3, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "", font=('Times', -15))
...
sexFrame = tkinter.LabelFrame(mainWindow, text="Sex (0-F and 1-M")
